...
self.addEventListener('fetch', e => {
  ...
  // Same-origin only, by construction — not a maintained list of
  // known third-party hostnames. Any cross-origin request (Firebase
  // Auth, Firestore, Cloudinary, WhatsApp, Nominatim, ibb.co, CDNs,
  // and anything else not yet named) is left completely untouched.
